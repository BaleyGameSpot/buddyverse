...
if ($sortby == 1) {
    if ($order == 0) $ord = " ORDER BY vSubject_" . $default_lang . " ASC"; else
...
// }
if ($sortby == 2) {
    if ($order == 0) $ord = " ORDER BY vPurpose ASC"; else
                    ...
                    <tr>
                        ...
                        <td width="10%" class=" padding-right10">
                            <select name="option" id="option" class="form-control">
                                ...
                                <option value="<?= 'vSubject_' . $default_lang ?>" <?php if ($option == "vSubject_$default_lang") {
                                    echo "selected";
                                } ?> >Email Subject
                                </option>
                                <!--   <option  value="<?= 'vEmail_Code' ?>" <?php if ($option == "vEmail_Code") {
                                    echo "selected";
                                } ?> >Email Code</option> -->
                                <option value="<?= 'vPurpose' ?>" <?php if ($option == "vPurpose") {
                                    echo "selected";
                                } ?> >Purpose
                                </option>
                            </select>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        <th width="20%">
                                            <a href="javascript:void(0);"
                                               onClick="Redirect(1,<?php if ($sortby == '1') {
                                                   echo $order;
                                               } else { ?>0<?php } ?>)">Email Subject <?php if ($sortby == 1) {
                                                    if ($order == 0) { ?>
                                        ...
                                        <!-- <th width="20%"><a href="javascript:void(0);" onClick="Redirect(2,<?php if ($sortby == '2') {
                                            echo $order;
                                        } else { ?>0<?php } ?>)">Email Code <?php if ($sortby == 2) {
                                        ...
                                        <th width="20%">
                                            <a href="javascript:void(0);"
                                               onClick="Redirect(2,<?php if ($sortby == '2') {
                                                   echo $order;
                                               } else { ?>0<?php } ?>)">Purpose <?php if ($sortby == 2) {
                                                    if ($order == 0) { ?>
                                                        <i class="fa fa-sort-amount-asc"
                                                           aria-hidden="true"></i> <?php } else { ?>
                                                        <i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php }
                                        ...
                                        <th width="8%" align="center" style="text-align:center;">
                                            <a href="javascript:void(0);"
                                               onClick="Redirect(4,<?php if ($sortby == '4') {
                                                   echo $order;
                                               } else { ?>0<?php } ?>)">Edit <?php if ($sortby == 4) {
                                                    if ($order == 0) { ?>
                                                        <i class="fa fa-sort-amount-asc"
                                                           aria-hidden="true"></i> <?php } else { ?>
                                                        <i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php }
                                                    ...
                                                    <?php if ($userObj->hasPermission('edit-email-templates')) { ?>
                                                        <div class="share-button openHoverAction-class"
                                                            ...
                                                            <label class="entypo-twitter" data-network="twitter"
                                                                ...
                                                                <a href="email_template_action.php?id=<?= $data_drv[$i]['iEmailId']; ?>"
