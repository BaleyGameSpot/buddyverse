...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
                        ...
                        <div class="form-group">
                            ...
                            <form method="post" action="" name="_state_form" id="_state_form" >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="vState"  id="vState" value="<?= isset($vState) ? $vState : '' ; ?>" placeholder="State Name" >
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="vStateCode"  id="vStateCode" value="<?= isset($vStateCode) ? $vStateCode : ''; ?>" placeholder="State Code" >
                                    </div>
                                </div>
                                <!-- <div class="row">
                                        <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-6">
                                                <input type="text" class="form-control" name="vCountryCodeISO_3"  id="vCountryCodeISO_3" value="<?= isset($vCountryCodeISO_3) ? $vCountryCodeISO_3 : ''; ?>" placeholder="Country Code ISO_3" required>
                                        </div>
                                </div> -->
                                ...
                                <!-- <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                                <input type="text" class="form-control" name="vPhoneCode"  id="vPhoneCode" value="<?= isset($vPhoneCode) ? $vPhoneCode : ''; ?>" placeholder="Country Phone Code" required>
                                        </div>
                                </div> -->
    ...
    <script>
        var form = $('#lunch').closest('form');
        $('#lunch').on('change', function () {
            form.validate().element('#lunch');
        });
    </script>
    </body>
    <!-- END BODY-->
