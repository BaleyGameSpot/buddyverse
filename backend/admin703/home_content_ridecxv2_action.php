...
$cubexthemeonh = 0;
if($THEME_OBJ->isRideCXv2ThemeActive()=='Yes') {
    $cubexthemeonh = 1;
}
...
/*
    ...
    if (!empty($img_arr)) {
        ...
        foreach ($img_arr as $key => $value) {
            ...
            if (!empty($value['name'])) {
                ...
                if ($key == 'safety_section_img_first') {
                    $second_safety_img = 1;
                }
                if ($key == 'safety_section_img_sec') {
                    $second_safety_img = 2;
                }
               ...
               if($key=='register_section_img_first') $img_str = 'img_first_';
               else if($key=='register_section_img_sec') $img_str = 'img_sec_';
               else if($key=='safety_section_img_first') $img_str = 'img_first_';
               else if($key=='safety_section_img_sec') $img_str = 'img_sec_';
               else $img_str = 'img';

                if($key=='how_it_work_section_img') $key = 'lHowitworkSection';
                else if($key=='travel_section_img') $key = 'lTravelSection';
                else if($key=='pool_section_img') $key = 'lPoolSection';
                ...
                else if ($key == 'safety_section_img_first' || $key == 'safety_section_img_sec') $key = 'lSecuresafeSection';
    ...
    if(isset($_POST['submit'])) {
        ...
        $safety_section_arr['main_subtitle'] = isset($_POST['safety_section_main_subtitle']) ? $_POST['safety_section_main_subtitle'] : '';
        $safety_section_arr['main_desc'] = isset($_POST['safety_section_main_desc']) ? $_POST['safety_section_main_desc'] : '';
        $safety_section_arr['title_first'] = isset($_POST['safety_section_title_first']) ? $_POST['safety_section_title_first'] : '';
        $safety_section_arr['title_sec'] = isset($_POST['safety_section_title_sec']) ? $_POST['safety_section_title_sec'] : '';
        $safety_section_arr['safety_section_description_first'] = isset($_POST['safety_section_description_first']) ? $_POST['safety_section_description_first'] : '';
        $safety_section_arr['safety_section_description_second'] = isset($_POST['safety_section_description_second']) ? $_POST['safety_section_description_second'] : '';
        
        $safety_section_arr['img_first'] = isset($sectionData['img_first']) ? $sectionData['img_first'] : '';
        $safety_section_arr['img_sec'] = isset($sectionData['img_sec']) ? $sectionData['img_sec'] : '';
                                            ...
                                            <?php for ($i=1; $i <= 4; $i++) { ?>
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-11">
                                                            <input type="text" class="form-control" name="how_it_work_section_hiw_title<?php echo $i ; ?>"  id="how_it_work_section_hiw_title<?php echo $i ; ?>" value="<?= $how_it_work_section['hiw_title'.$i]; ?>" placeholder="Title">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-11">
                                                            <textarea class="form-control" name="how_it_work_section_hiw_desc<?php echo $i ; ?>"  id="how_it_work_section_hiw_desc<?php echo $i ; ?>" value="<?= $how_it_work_section['hiw_desc'.$i]; ?>" placeholder="Description" rows="3"><?= $how_it_work_section['hiw_desc'.$i]; ?></textarea>
                                                        </div>
                                                    </div>   
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-11">
                                                            <? if ($how_it_work_section['hiw_img'.$i] != '') { ?>
                                                               <img src="<?= $tconfig["tsite_url"].'resizeImg.php?h=200&src='.$tconfig["tsite_upload_apptype_page_images"].$template.'/'.$how_it_work_section['hiw_img'.$i]; ?>" class="innerbg_image"/ style="max-height:100px;">
                                ...
                                <div class="body-div innersection">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="travel_section_title"  id="travel_section_title" value="<?= $travel_section['title']; ?>" placeholder="Title" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-12">
                                                <textarea class="form-control ckeditor" rows="10" name="travel_section_desc"  id="travel_section_desc"  placeholder="Description"><?= $travel_section['desc']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-6">
                                                <? if ($travel_section['img'] != '') { ?>
                                                    <img src="<?= $tconfig["tsite_upload_apptype_page_images"].$template.'/'.$travel_section['img']; ?>" class="innerbg_image" />
                                                <? } ?>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <!--  <div class="row">
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="col-lg-6">
                                               <input type="text" class="form-control" name="pool_section_title"  id="pool_section_title" value="<?= $pool_section['title']; ?>" placeholder="Title" required>
                                           </div>
                                       </div>
                                       <div class="row">
                                           <div class="col-lg-12">
                                           ...
                                           <div class="col-lg-12">
                                               <textarea class="form-control ckeditor" rows="10" name="pool_section_desc"  id="pool_section_desc"  placeholder="Description"><?= $pool_section['desc']; ?></textarea>
                                           </div>
                                       </div>
                                       <div class="row">
                                           <div class="col-lg-12">
                                           ...
                                           <div class="col-lg-6">
                                               <? if ($pool_section['img'] != '') { ?>
                                                   <img src="<?= $tconfig["tsite_upload_apptype_page_images"].$template.'/'.$pool_section['img']; ?>" class="innerbg_image"/>
                                               <? } ?>
                                ...
                                <div class="body-div innersection">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="safety_section_main_title" id="safety_section_main_title" value="<?= $safety_section['main_title']; ?>" placeholder="Title" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <textarea class="form-control ckeditor" rows="10" name="safety_section_main_desc"  id="safety_section_main_desc"  placeholder="Description"><?= $safety_section['main_desc']; ?></textarea>
                                               <!--  <input type="text" class="form-control" name="safety_section_main_desc" id="safety_section_main_desc" value="<?= $safety_section['main_desc']; ?>" placeholder="Description" required> -->
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="safety_section_title_first" id="safety_section_title_first" value="<?= $safety_section['title_first']; ?>" placeholder="Title" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-6">
                                                <? if ($safety_section['img_first'] != '') { ?>
                                                    <img src="<?= $tconfig["tsite_url"] . 'resizeImg.php?h=300&src=' . $tconfig["tsite_upload_apptype_page_images"] . $template . '/' . $safety_section['img_first']; ?>" class="innerbg_image" />
                                                <? } ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <textarea class="form-control ckeditor" rows="10" name="safety_section_description_first"  id="safety_section_description_first"  placeholder="Description"><?= $safety_section['safety_section_description_first']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="safety_section_title_sec" id="safety_section_title_sec" value="<?= $safety_section['title_sec']; ?>" placeholder="Title" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-6">
                                                <? if ($safety_section['img_sec'] != '') { ?>
                                                    <img src="<?= $tconfig["tsite_url"] . 'resizeImg.php?h=300&src=' . $tconfig["tsite_upload_apptype_page_images"] . $template . '/' . $safety_section['img_sec']; ?>" class="innerbg_image" />
                                                <? } ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <textarea class="form-control ckeditor" rows="10" name="safety_section_description_second"  id="safety_section_description_second"  placeholder="Description"><?= $safety_section['safety_section_description_second']; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="body-div innersection">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <textarea class="form-control ckeditor" rows="10" name="register_section_main_desc"  id="register_section_main_desc"  placeholder="Description"><?= $register_section['main_desc']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
