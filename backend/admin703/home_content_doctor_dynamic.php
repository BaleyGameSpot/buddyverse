...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="UTF-8" />
        <title>Admin | Deliverall Home Content <?= $action; ?></title>
                ...
                <div class="inner">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <h2><?= $action; ?> Deliverall Home Content (<?php echo $title; ?>)</h2>
                            <? } else { ?>
                            <h2><?= $action; ?> Doctor inner Home Content (<?php echo $title; ?>)</h2>
                            <? } ?>
                                 ...
                                 <div class="body-div innersection">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="banner_section_sub_title"  id="banner_section_sub_title" value="<?= $banner_section['sub_title_'.$vCode]; ?>" placeholder="Sub Title">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
