    ...
    if (!empty($img_arr)) {
        ...
        foreach ($img_arr as $key => $value) {
            ...
            if (!empty($value['name'])) {
                ...
                if ($key == 'register_section_img_first') $img_str = 'img_first_'; else if ($key == 'register_section_img_sec') $img_str = 'img_sec_'; else if ($key == 'safety_section_img_first') $img_str = 'img_first_'; else if ($key == 'safety_section_img_sec') $img_str = 'img_sec_'; else $img_str = 'img';
                if ($key == 'how_it_work_section_img') $key = 'lHowitworkSection'; else if ($key == 'travel_section_img') $key = 'lTravelSection'; else if ($key == 'pool_section_img') $key = 'lPoolSection'; else if ($key == 'call_section_img') $key = 'lCalltobookSection'; else if ($key == 'general_section_img') $key = 'lGeneralBannerSection'; else if ($key == 'general_section_img_sec') $key = 'lGeneralBannerSection'; else if ($key == 'register_section_img_first' || $key == 'register_section_img_sec') $key = 'lRegisterSection'; else if ($key == 'safety_section_img_first' || $key == 'safety_section_img_sec') $key = 'lSecuresafeSection';
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-11">
                                                    <textarea class="form-control"
                                                              ...
                                                              value="<?= $how_it_work_section['hiw_desc' . $i]; ?>"
                                                              placeholder="Description"
                                                              rows="3"><?= $how_it_work_section['hiw_desc' . $i]; ?></textarea>
                                                </div>
                                            </div>
                                            <!-- Image  -->
                                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea class="form-control ckeditor" rows="10" name="travel_section_desc"
                                                  ...
                                                  placeholder="Description"><?= $travel_section['desc']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea class="form-control ckeditor" rows="10" name="pool_section_desc"
                                                  ...
                                                  placeholder="Description"><?= $pool_section['desc']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="form-control ckeditor" rows="10"
                                                  ...
                                                  placeholder="Description"><?= $safety_section['main_desc']; ?></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="safety_section_title_first"
                                               ...
                                               value="<?= $safety_section['title_first']; ?>" placeholder="Title"
                                               required>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <? if ($safety_section['img_first'] != '') { ?>
                                            <img src="<?= $tconfig["tsite_url"] . 'resizeImg.php?h=300&src=' . $tconfig["tsite_upload_apptype_page_images"] . $template . '/' . $safety_section['img_first']; ?>"
                                                 class="innerbg_image"/>
                                        <? } ?>
                                        <input type="file" class="form-control FilUploader"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="form-control ckeditor" rows="10"
                                                  ...
                                                  placeholder="Description"><?= $safety_section['safety_section_description_first']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="safety_section_title_sec"
                                               ...
                                               value="<?= $safety_section['title_sec']; ?>" placeholder="Title"
                                               required>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <? if ($safety_section['img_sec'] != '') { ?>
                                            <img src="<?= $tconfig["tsite_url"] . 'resizeImg.php?h=300&src=' . $tconfig["tsite_upload_apptype_page_images"] . $template . '/' . $safety_section['img_sec']; ?>"
                                                 class="innerbg_image"/>
                                        <? } ?>
                                        <input type="file" class="form-control FilUploader"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="form-control ckeditor" rows="10"
                                                  ...
                                                  placeholder="Description"><?= $safety_section['safety_section_description_second']; ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="form-control ckeditor" rows="10"
                                                  ...
                                                  placeholder="Description"><?= $register_section['main_desc']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
