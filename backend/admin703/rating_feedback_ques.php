...
$data_drv = $obj->MySQLSelect("SELECT iFeedbackId, JSON_UNQUOTE(JSON_VALUE(tQuestion, '$.tQuestion_".$default_lang."')) as tQuestion, eStatus, iDisplayOrder FROM $tbl_name WHERE eStatus != 'Deleted' $ssql $ord");
...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8" />
        <title><?= $SITE_NAME ?> | Rating Feedback Questions</title>
                            ...
                            <div class="col-lg-12">
                                <div class="admin-nir-export">
                                    <div class="changeStatus col-lg-12 option-box-left">
                                        <span class="col-lg-2 new-select001">
                                            ...
                                            <select name="changeStatus" id="changeStatus" class="form-control" onchange="ChangeStatusAll(this.value);">
                                                ...
                                                ?> >Deactivate</option>
                                                <?php } ?>
                                                <?php if ($eStatus != 'Deleted' && $userObj->hasPermission('delete-rating-feedback-ques')) { ?>
                                    ...
                                    <div class="panel-heading">
                                        ...
                                        <button type="button" onclick="showExportTypes('rating_feedback_ques')" class="btnalt button11">Export</button>
                                        <?php } ?>
                                    </div>
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th width="5%" class="align-center"><a href="javascript:void(0);" onClick="Redirect(2,<?php
                                                        if ($sortby == '2') {
                                                            echo $order;
                                                        } else {
                                                            ?>0<?php } ?>)">Order <?php
                                            ...
                                            <tbody>
                                                ...
                                                if (!empty($data_drv)) {
                                                    for ($i = 0; $i < $count_all; $i++) {
                                                        ...
                                                        <tr class="gradeA">
                                                            <?php if ($userObj->hasPermission(['update-status-rating-feedback-ques', 'delete-rating-feedback-ques'])) { ?>
                                                            <td align="center" style="text-align:center;"><input type="checkbox" id="checkbox" name="checkbox[]" value="<?php echo $data_drv[$i]['iFeedbackId']; ?>" />&nbsp;</td>                                                  
                                                            <?php } ?>
                                                            <td><?= $tQuestion; ?></td>
                                                            ...
                                                            <td align="center" style="text-align:center;" class="action-btn001">
                                                                <div class="share-button openHoverAction-class" style="display: block;">
                                                                    ...
                                                                    <div class="social show-moreOptions openPops_<?= $data_drv[$i]['iFeedbackId']; ?>">
                                                                        <ul>
                                                                            <?php if ($userObj->hasPermission('edit-rating-feedback-ques')) { ?>
                                                                            <li class="entypo-twitter" data-network="twitter">
                                                                                <a href="rating_feedback_ques_action.php?id=<?= $data_drv[$i]['iFeedbackId']; ?>" data-toggle="tooltip" title="Edit">
