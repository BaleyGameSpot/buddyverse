                    ...
                    <tr>
                        ...
                        <td width="10%" class=" padding-right10">
                            <select name="option" id="option" class="form-control">
                                ...
                                <option value="<?= 'vSubject_' . $default_lang; ?>" <?php if ($option == 'vSubject_' . $default_lang) { echo 'selected'; } ?> >
                                    SMS Title
                                </option>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        <th width="20%">
                                            <a href="javascript:void(0);"
                                               onClick="Redirect(3,<?php if ($sortby == '3') {
                                                   echo $order;
                                               } else { ?>0<?php } ?>)">SMS Title <?php if ($sortby == 3) {
                                                    if ($order == 0) { ?>
                                        ...
                                        <th width="20%">
                                            <a href="javascript:void(0);"
                                               onClick="Redirect(1,<?php if ($sortby == '1') {
                                                   echo $order;
                                               } else { ?>0<?php } ?>)">SMS Code <?php if ($sortby == 1) {
                                                    if ($order == 0) { ?>
                                                        <i class="fa fa-sort-amount-asc"
                                                           aria-hidden="true"></i> <?php } else { ?>
                                                        <i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php }
                                        ...
                                        <th width="8%" align="center" style="text-align:center;">
                                            <a href="javascript:void(0);"
                                               onClick="Redirect(5,<?php if ($sortby == '4') {
                                                   echo $order;
                                               } else { ?>0<?php } ?>)">Edit <?php if ($sortby == 2) {
                                                    if ($order == 0) { ?>
                                                        <i class="fa fa-sort-amount-asc"
                                                           aria-hidden="true"></i> <?php } else { ?>
                                                        <i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php }
                                                ...
                                                <td align="center" style="text-align:center;" class="action-btn001">
                                                        ...
                                                        <div class="share-button openHoverAction-class"
                                                            ...
                                                            <label class="entypo-twitter" data-network="twitter"
                                                                ...
                                                                <a href="sms_template_action.php?id=<?= $data_drv[$i]['iSendMessageId']; ?>"
