...
$backUrl = "rental_package.php?id=".$iVehicleTypeId;
/*------------------get lang-----------------*/
...
if (isset($_POST['btnsubmitnew']))
{
    if(SITE_TYPE =='Demo') {
        $_SESSION['success'] = 2;
        header("Location:rental_package.php?id=".$iVehicleTypeId);exit;
    }
...
$Rental_Package_Data = !empty($Rental_Package_Data) ? $Rental_Package_Data[0] : array();
...
if(isset($languageList) && !empty($languageList))
{
    ...
    {
        $PackageNameLang = 'vPackageName_'.$lang['vCode'];
        $FeatureDataArr[$PackageNameLang] = isset($Rental_Package_Data[$PackageNameLang])  ? $Rental_Package_Data[$PackageNameLang] : '';
    }
}
?>
<!DOCTYPE html>
                ...
                <div class="form-group">
                    ...
                    <form id="rental_package" name="rental_package" method="post" action="" enctype="multipart/form-data" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="fPrice"  id="fPrice" value="<?php echo isset($Rental_Package_Data['fPrice']) ? $Rental_Package_Data['fPrice'] : ''  ?>" onkeypress="return isNumberKey(event)">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="fKiloMeter"  id="fKiloMeter" value="<?php echo isset($Rental_Package_Data['fKiloMeter']) ? $Rental_Package_Data['fKiloMeter'] : ''  ?>" onkeypress="return isNumberKey(event)">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-6">
                                <input type="number" class="form-control" name="fHour"  id="fHour" value="<?php echo isset($Rental_Package_Data['fHour']) ? $Rental_Package_Data['fHour'] : ''  ?>" min="1"  step="1" onkeypress="return event.charCode >= 48 && event.charCode <= 57" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="fPricePerKM"  id="fPricePerKM" value="<?php echo isset($Rental_Package_Data['fPricePerKM']) ? $Rental_Package_Data['fPricePerKM'] : '' ?>" onkeypress="return isNumberKey(event)">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" value="<?php echo isset($Rental_Package_Data['fPricePerHour']) ? $Rental_Package_Data['fPricePerHour'] : '' ?>" name="fPricePerHour"  id="fPricePerHour" value="" onkeypress="return isNumberKey(event)">
                            </div>
                        </div>
                        <div class="row">
                        <div class="col-lg-12">
