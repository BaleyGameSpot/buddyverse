...
$iFeedbackId = isset($_REQUEST['iFeedbackId']) ? $_REQUEST['iFeedbackId'] : '';
...
if ($method == 'delete' && $iFeedbackId != '') {
	...
	updateSystemData();
	header("Location:".$tconfig["tsite_url_main_admin"]."rating_feedback_ques.php?".$parameters); exit;
}
