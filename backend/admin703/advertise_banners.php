                                    ...
                                    if (!empty($data_drv)) {
                                        for ($i = 0; $i < scount($data_drv); $i++) {
                                            ...
                                            if (isset($usedCountArr[$data_drv[$i]['iAdvertBannerId']]) && $usedCountArr[$data_drv[$i]['iAdvertBannerId']] > 0 && $data_drv[$i]['eImpression'] == "Limited") {
                                                ...
                                                $bannerUsedCount = isset($usedCountArr[$data_drv[$i]['iAdvertBannerId']]) ? $usedCountArr[$data_drv[$i]['iAdvertBannerId']] : '';
                                            }

                                            $date_format_data_array = array(
                                                'tdate' => $data_drv[$i]['dAddedDate'],
                                                'langCode' => $default_lang,
                                                'DateFormatForWeb' => 1
                                            );
                                            $get_Added_date_format = DateformatCls::getNewDateFormat($date_format_data_array);
                                            ?>
                                            <tr class="gradeA">
                                                <?php if ($userObj->hasPermission(['update-status-advertise-banner', 'delete-advertise-banner'])) { ?>
