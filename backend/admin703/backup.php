                        ...
                        <div class="right_bkp001 bkp0011 bkpSelectTime2">
                            ...
                            <span>
                                <!--	<form name="_backup_form" id="_backup_form" method="post" >
                                                <b><input type="checkbox" name="BACKUP_ENABLE" id="backupEn" <?php if (isset($backupEn) && $backupEn == 'Yes') echo 'checked'; ?> value="Yes">&nbsp;&nbsp;&nbsp;Take schedule backup everyday at &nbsp;</b>
                                                <select class="form-control bkpSelectTime bkpSelectTime1" name="BACKUP_TIME">
                                <?php for ($i = 0; $i < 24; $i++): ?>
                                                                            <option value="<?php echo $i; ?>" <?php if (isset($backupTm) && $backupTm == $i) echo "selected"; ?>><?php echo $i % 12 ? $i % 12 : 12 ?>:00 <?php echo $i >= 12 ? 'pm' : 'am' ?></option>
                                <?php endfor; ?>
                                                </select>
                                            ...
                                            <tbody>
                                                ...
                                                if (!empty($data_drv)) {
                                                    for ($i = 0; $i < scount($data_drv); $i++) {
                                                        ...
                                                        $date_format_data_array['tdate'] = $data_drv[$i]['dDate'];
                                                        $get_dDate_format = DateformatCls::getNewDateFormat($date_format_data_array);
                                                        ?>
                                                        <tr class="gradeA">
                                                            <td><?php echo clearEmail($data_drv[$i]['vFile']); ?></td>
                                                            <td align="center"><?php echo $get_dDate_format['tDisplayDateTime'];//$data_drv[$i]['dDate']; ?></td>
...
<?php include('pagination_n.php'); ?>
        ...
        <script>
            ...
            function saveSchedule() {
                ...
                var ajaxData = {
                    'URL': '<?= $tconfig['tsite_url_main_admin'] ?>save_backup_schedule.php',
                    'AJAX_DATA': formData,
