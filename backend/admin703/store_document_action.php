...
$count_all = scount($iCompanyIddoc);
...
$count_all1 = scount($iCompanyIddoc1);
        ...
        if ($expDate != "") {
            ...
            if ($db_licence[0]['ex_date'] == $expDate) {
                ...
                if ($_FILES['company_doc']['name'] != "") {
                    ...
                    $error = $validobj->validateFileType($_FILES['company_doc'], $tconfig["tsite_upload_docs_file_extensions"], $docUploadingExtenstionMsg); 
        ...
        <div class="inner">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a class="back_link" href="<?= $LOCATION_FILE_ARRAY['STORE.PHP']; ?><?= isset($_REQUEST['type']) ? '?type=' . $_REQUEST['type'] : '' ?>">
                                    ...
                                    <div class="panel-body">
                                        <?php if ($iCompanyIddoc[$i]['doc_file'] != '' && file_exists('../webimages/upload/documents/company/' . $_REQUEST['id'] . '/' . $db_userdoc[$i]['doc_file'])) { ?><?php
                                            ...
                                            if ($file_ext == 'is_image') {
                                                ?>
                                                <a href="<?= $tconfig["tsite_upload_compnay_doc"] . '/' . $_REQUEST['id'] . '/' . $iCompanyIddoc[$i]['doc_file'] ?>" target="_blank"><img src="<?= $tconfig["tsite_upload_compnay_doc"] . '/' . $_REQUEST['id'] . '/' . $iCompanyIddoc[$i]['doc_file'] ?>" style="width:200px;cursor:pointer;" alt="YOUR DRIVING LICENCE"/></a><!-- data-toggle="modal" data-target="#myModallicence" -->
                                            <?php }
                                        ...
                                        <div class="panel panel-default upload-clicking">
                                            ...
                                            <div class="panel-body" style="display: inline-block;">
                                                <?php if ($iCompanyIddoc1[$i]['req_file'] != '' && file_exists('../webimages/upload/documents/company/' . $_REQUEST['id'] . '/' . $iCompanyIddoc1[$i]['req_file'])) { ?><?php
                                                    ...
                                                    if ($file_ext == 'is_image') {
                                                        ?>
                                                        <a href="<?= $tconfig["tsite_upload_compnay_doc"] . '/' . $_REQUEST['id'] . '/' . $iCompanyIddoc1[$i]['doc_file'] ?>" target="_blank"><img src="<?= $tconfig["tsite_upload_compnay_doc"] . '/' . $_REQUEST['id'] . '/' . $iCompanyIddoc1[$i]['req_file'] ?>" style="width:200px;cursor:pointer;" alt="YOUR DRIVING LICENCE"/></a><!-- data-toggle="modal" data-target="#myModallicence" -->
                                                    <?php } else { ?>
                                                        <p>
                                                            <a href="<?= $tconfig["tsite_upload_compnay_doc"] . '/' . $_REQUEST['id'] . '/' . $iCompanyIddoc1[$i]['req_file'] ?>" target="_blank"><?php echo $iCompanyIddoc1[$i]['req_file']; ?></a>
                                                        </p>
                                                    <?php } ?><?php
                                                }
                                                else {
...
<script>
    ...
    function setModel001(idVal, ex_status) {
        ...
        var ajaxData = {
            'URL': '<?= $tconfig['tsite_url_main_admin'] ?>store_document_fetch.php',
