...
if (isset($_POST['submit'])) { //form submit
    ...
    if ($count_all > 0) {
        for ($i = 0; $i < $count_all; $i++) {
            ...
            $where = '';
            if ($id != '') {
                $selectdata = $obj->MySQLSelect("SELECT count(iFaqcategoryId) as total FROM " . $tbl_name . " WHERE `iUniqueId` = '" . $id . "' AND vCode = '" . $db_master[$i]['vCode'] . "'");
                if ($selectdata[0]['total'] > 0) {
                    $q = "UPDATE ";
            ...
            $fileextension = $img_arr[scount($img_arr) - 1];
                ...
                <div class="form-group">
                    ...
                    <form method="post" name="_faq_cat_form" id="_faq_cat_form" action="" enctype="multipart/form-data">
                        ...
                        <?php if (scount($db_master) > 1) { ?>
                            <div class="row">
                                <div class="col-lg-12">
                                    <label>FAQ Category <span class="red"> *</span></label>
                                </div>
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" class="form-control <?= ($id == "") ? 'readonly-custom' : '' ?>"
                                           id="vTitle_Default" name="vTitle_Default"
                                           value="<?= isset($arrLang['vTitle_' . $default_lang]) ? $arrLang['vTitle_' . $default_lang] : ''; ?>"
                                           data-originalvalue="<?= isset($arrLang['vTitle_' . $default_lang]) ? $arrLang['vTitle_' . $default_lang] : ''; ?>"
                                           readonly="readonly" <?php if ($id == "") { ?> onclick="editFaqCategory('Add')" <?php } ?>>
                                </div>
                                <?php if ($id != "") { ?>
                                    <div class="col-lg-2">
                                        <button type="button" class="btn btn-info" data-toggle="tooltip"
                                                data-original-title="Edit" onclick="editFaqCategory('Edit')"><span
                            ...
                            <div class="modal fade" id="faq_cat_Modal" tabindex="-1" role="dialog" aria-hidden="true"
                                 data-backdrop="static" data-keyboard="false">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content nimot-class">
                                        <div class="modal-header">
                                            <h4>
                                                <span id="modal_action"></span> FAQ Category
                                        ...
                                        <div class="modal-footer" style="margin-top: 0">
                                            ...
                                            <div class="nimot-class-but" style="margin-bottom: 0">
                                                <button type="button" class="save" style="margin-left: 0 !important"
                                                        onclick="saveFaqCategory()"><?= $langage_lbl['LBL_Save']; ?></button>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" class="form-control" id="vTitle_<?= $default_lang ?>"
                                           ...
                                           value="<?= $arrLang['vTitle_' . $default_lang]; ?>" required>
                                </div>
                            </div>
                        <?php } ?>
...
<script>
    ...
    var default_lang_field = $("#vTitle_"+DEFAULT_LANG);
    var default_lang_field_error = $("#vTitle_"+DEFAULT_LANG+'_error');
