                ...
                <div class="form-group location-wise-box">
                    ...
                    <form method="post" action="" enctype="multipart/form-data" id="locationfareForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <select name="iFromLocationId" class="form-control" required="required"
                                        onChange="getvehilcetype(this.value, '');">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <select class="form-control selectpicker" name='iVehicleTypeId' id="iVehicleTypeId"
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <label> Enter Flat Fare (Price In <?= $db_currency[0]['vName'] ?>)<span
                                            class="red">*</span> <i class="icon-question-sign" data-placement="top"
                                                                    data-toggle="tooltip"
                                                                    data-original-title='Enter Flat fare which includes updated toll fare in this route'></i></label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="fFlatfare" id="fFlatfare"
                                       value="<?= $fFlatfare; ?>" required="required">
                            ...
                            <div class="col-lg-12">
                                <?php if (($action == 'Edit' && $userObj->hasPermission('edit-location-wise-fare')) || ($action == 'Add' && $userObj->hasPermission('create-location-wise-fare'))) { ?>
                                    <input type="submit" class="save btn-info" name="submit" id="submit"
                                           value="<?= $action; ?> Location Wise Fare">
                                <?php } else { ?>
                                    <a href="locationwise_fare.php" class="btn btn-default back_link">Cancel</a>
                                <?php } ?>
                                <input type="reset" class="btn btn-default back_link" onclick="resetSelection();"
...
<script>
    ...
    function getvehilcetype(id, selected) {
        selected = selected || '';
        var ajaxData = {
            'URL': '<?= $tconfig['tsite_url_main_admin'] ?>ajax_get_vehicletype_fixfare.php',
