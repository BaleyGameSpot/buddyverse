...
<?php
	...
	for($i=0;$i< scount($data_ex_doc);$i++){
	...
	if((scount($array_driver_detail) > 0 )|| (scount($array_cmp_detail) > 0)){
	
		if(scount($array_driver_detail) > 0){
			...
			for($j=0; $j<scount($array_driver_detail); $j++){
		...
		if(scount($array_cmp_detail) > 0){
			...
			for($j=0; $j<scount($array_cmp_detail); $j++){
