                            ...
                            <div class="trip-detail-page-inner clearfix">
                                ...
                                <div class="trip-detail-page-right1" style="font-weight: 400;font-size: 15px">
                                    <?php if (strtoupper($eType) == "RIDE") { ?>
                                        Dear <?= $userName ?>,<br><br>Driver <?= $ProviderName; ?> has added an extra charges for <?= $jobWord; ?> number <b><?= $db_trip_data['vRideNo']; ?></b>.  Please refer below added charges and provide a verification code to the driver to confirm added charges.<br><br><span>Toll Charges : <b><?= $fTollPrice ?></b></span><br><span>Other Charges : <b><?= $fOtherCharges ?></b></span><br><span>Driver discount: <b><?= $fDriverDiscount ?></b></span><br><span>Total Amount: <b><?= $totalAmount ?></b></span><br><br>
                                    <?php } else { ?>
                                        Dear <?= $userName ?>,<br><br>Provider <?= $ProviderName; ?> has added an extra charges for <?= $jobWord; ?> number <b><?= $db_trip_data['vRideNo']; ?></b>.  Please refer below added charges and provide a verification code to the provider to confirm added charges.<br><br><span>Service Cost: <b><?= $serviceCost ?></b></span><br><span>Material Fee: <b><?= $fMaterialFee ?></b></span><br><span>Misc Fee: <b><?= $fMiscFee ?></b></span><br><span>Provider discount: <b><?= $fDriverDiscount ?></b></span><br><span>Total Amount: <b><?= $totalAmount ?></b></span><br><br>
                                    <?php } ?>
                                    <span>Approve/Decline: <?= $linkAcceptDecline; ?></span><br><span><br></span><span><br></span>
                                </div>
                            </div>
                        </div>
                        <?php
