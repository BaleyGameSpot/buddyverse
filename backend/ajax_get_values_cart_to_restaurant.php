...
$OrderDetailscount = scount($OrderDetails);
...
if (!empty($OrderDetails)) {
    ...
    for ($j = 0; $j < scount($OrderDetails); $j++) {
        ...
        if ($typeitems == 'new') {
            ...
            for ($fd = 0; $fd < scount($explodeOption); $fd++) {
            ...
            for ($df = 0; $df < scount($explodeAddon); $df++) {
    ...
    for ($i = 0; $i < scount($OrderDetails); $i++) {
