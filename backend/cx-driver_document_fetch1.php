    ...
    <form class="form-horizontal frm6" id="frm6" method="post" enctype="multipart/form-data" action="cx-driver_document_action.php?id=<?php echo $id[1] ; ?>&master=<?php echo $id[0] ; ?> " name="frm6">
        ...
        <div class="model-body">
            ...
            <div class="fileupload fileupload-new" data-provides="fileupload">
                ...
                <div class="newrow">
                    ...
                    <!-- <span id="driver_doc-error" class="help-block error has-error"  style="width: 100%;"></span> -->
                    <div class="upload-error error_div"><span class="file_error"></span></div>
                </div>
        ...
        <?php if($db_user[0]['ex_status']=='yes' || $db_user1[0]['ex_status']=='yes') { ?>
            <div class="filters-column exp-date newrow">
                ...
                <!-- <span id="dtpckrdLicenceExp-error" class="help-block error has-error" style="width: 100%; text-align: center;"></span> -->
                <div class="exp-error error_div"><span class="exp_error"></span></div>
            </div>
        <?php }  ?>
    ...
    $('#frm6').validate({
        ...
        errorPlacement: function (error, e) {
            /*if (element.attr("name") == "vCurrencyDriver")
                ...
                error.insertAfter(element);*/
                e.parents('.newrow').find('.error_div').append(error);
        },
