...
$script="Help Center";
$meta = $STATIC_PAGE_OBJ->FetchStaticPage(2,$vCode);
?>
<!DOCTYPE html>
...
<div id="main-uber-page">
	<?php if($isFromApp == 'Yes'){ ?>
		...
		<div class="gen-cms-page" style="padding:20px 0;background-color:#fff;">
	                <div class="gen-cms-page-inner">
		<?php } else { ?>
			<div class="page-contant" style="padding:20px 0;background-color:#fff;">
